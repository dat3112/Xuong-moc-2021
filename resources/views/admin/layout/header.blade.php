            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="footer"><a href="/backend/#">See All Messages</a></li>
                    </ul>
                </li>
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="footer"><a href="/backend/#">View all</a></li>
                    </ul>
                </li>
                ...
                <li class="dropdown tasks-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="footer">
                            <a href="/backend/#">View all tasks</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-body">
                            <div class="row">
                                <div class="col-xs-4 text-center">
                                    <a href="/backend/#">Followers</a>
                                </div>
                                <div class="col-xs-4 text-center">
                                    <a href="/backend/#">Sales</a>
                                </div>
                                <div class="col-xs-4 text-center">
                                    <a href="/backend/#">Friends</a>
                                </div>
                            </div>
                            <!-- /.row -->
                        </li>
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="/backend/#" class="btn btn-default btn-flat">Profile</a>
                            </div>
                            <div class="pull-right">
                                <a href="/backend/#" class="btn btn-default btn-flat">Sign out</a>
                            </div>
                        </li>
                    </ul>
                </li>
